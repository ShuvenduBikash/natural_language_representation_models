...
def _local_perm(inputs, targets, is_masked, perm_size, seq_len):
    ...
    non_mask_tokens = (~is_masked) & non_func_tokens.type(torch.ByteTensor)
    ...
    target_tokens = masked_or_func_tokens & non_func_tokens.type(torch.ByteTensor)
    ...
    perm_mask = (self_rev_index[:, None] <= rev_index[None, :]).type(torch.ByteTensor) &  masked_or_func_tokens
